...
\headers{Greedy parameter selection for one-way equations}{M.K. Sleeman, and Tim Colonius}

% Title. If the supplement option is on, then "Supplementary Material"
% is automatically inserted before the title.
\title{Greedy recursion parameter selection for one-way spatial integration of hyperbolic equations\thanks{Submitted to the editors October 27, 2025.
